...
fun date(date: String): Boolean { //12 JAN 2020
    ...
    val regexp = "\\d{0,2}\\s$month\\s\\d{4}"

    val pattern = regexp.toRegex()
    val result = date.matches(pattern)
    println(result)
...
fun log() {
    val line =
        "2020-01-14 12:13:58.374 EET FINE: LOGIN (CASSystemUser): UserID=\"CASSystemUser\", C" +
                "lient=\"Server client\", O" +
                "rigin=\"193.42.108.58\", SessionID=\"ad77c93f-b1e9-43c8-aa64-aff4630d8473\" "
